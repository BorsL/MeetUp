...
const LandingPage = () => {
  ...
  return (  
    <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="p-10 text-base text-gray-300 font-extrabold lg:text-xl">
       ...
       {/* Footer */}
        <div className="absolute bottom-5 text-gray-300 font-thin flex items-center space-x-2">
        <span>
